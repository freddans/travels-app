...
import com.freddan.travels.VO.Currency;
...
import com.freddan.travels.repositories.BookingItemRepository;
    ...
    public List<BookingItemResponseTemplateVO> findMyBookingItems(long customerId) {
        ...
        if (customer != null) {
            ...
            for (BookingItem bookingItem : myBookings) {
                ...
                Currency totalCost = restTemplate.getForObject("http://CURRENCY/api/v1/currency/" + bookingItem.getTrip().getPricePerWeek(), Currency.class);
