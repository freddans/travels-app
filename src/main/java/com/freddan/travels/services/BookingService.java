...
import com.freddan.travels.repositories.BookingRepository;
...
public class BookingService {
    ...
    public ResponseTemplateVO createBooking(long customerId, long tripId) {
        ...
        if (customer != null && trip != null) {
            ...
            Currency totalCost = restTemplate.getForObject("http://CURRENCY/api/v1/currency/" + costPerWeek, Currency.class);
